...
public class GirokontoController {
	...
	private ArrayList<Buchung> al_Buchung;
	...
	/**
	 * @return the al_Buchung
	 */
	public ArrayList<Buchung> get_al_Buchung() 
	{
		return al_Buchung;
	}
	...
	/**
	 * @param al_Buchung the al_Buchung to set
	 */
	public void set_al_Buchung(ArrayList<Buchung> al_Buchung) 
	{
		this.al_Buchung = al_Buchung;
	}
